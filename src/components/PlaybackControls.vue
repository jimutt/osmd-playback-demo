    ...
    <v-bottom-sheet inset 
      ...
      <v-card tile>
        ...
        <v-list class="blue lighten-5">
          <v-slider v-if="this.playbackEngine && this.playbackEngine.iterationSteps > 0"
          ...
          <v-list-tile>
            ...
            <v-list-tile-action :class="{ 'mr-2': $vuetify.breakpoint.mdAndUp }">
              <v-btn icon @click="playbackEngine.state === 'PAUSED' ? playbackEngine.resume() : playbackEngine.play()" 
